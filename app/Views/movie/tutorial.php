...
<main>
    <h2>Como copiar o link embed?</h2>
    <h3>Passo 1:</h3>
    <p>Abra o vídeo do YouTube que deseja incorporar em seu site ou plataforma.</p><br>
    <h3>Passo 2:</h3>
    <p>Clique no botão "Compartilhar" abaixo do vídeo, localizado ao lado do botão "Curtir" e "Não curtir".</p>
    <img src="images/tutorial/img1.png" alt=""><br>
    <h3>Passo 3:</h3>
    <p>Clique no botão "Incorporar" na lista de opções de compartilhamento.</p>
